...
\section[Symbolic AI]{Symbolic \Gls{AI}}\label{subsec:symbolic-ai}
%
...
\subsection[First-order logic]{\Glsentrylong{FOL}}\label{subsubsec:first-order-logic}
%
...
\subsection{Datalog}\label{subsubsec:datalog}
%
...
\subsection[Description logic]{\Glsentrylong{DL}}\label{subsubsec:dl}
%
...
\subsection[Ontologies and knowledge graph]{Ontologies and \glsentrylong{KG}}\label{subsubsec:ontologies-and-kg}
%
...
\subsection[Limits of symbolic AI]{Limits of symbolic \Gls{AI}}\label{subsubsec:limits-of-symbolic-ai}
%



\section[Sub-symbolic AI]{Sub-symbolic \Gls{AI}}\label{subsec:sub-symbolic-ai}
%
...
\subsection[Decision trees]{\Glsentrylongpl{DT}}\label{subsubsec:non-neural-models}
%
...
\subsection[Neural networks]{\Glsentrylongpl{NN}}\label{subsubsec:neural-networks}
...
\section[Explainable AI]{\Glsentrylong{XAI}}\label{subsec:xai}
%
