...
\subsection{A good tradeoff language for SKI}\label{subsec:ski-stratified-datalog-with-negation}
%
Stratified Datalog with negation is a variant of Datalog~\cite{DBLP:books/mc/18/MaierTKW18} with no recursion -- neither direct nor indirect -- yet supporting negated atoms.
%
...
\section{An example of a guided learning SKI algorithm}\label{sec:ski-contribution-kill}
%
...
\section{An example of a structuring SKI algorithm}\label{sec:ski-contribution-kins}
%
