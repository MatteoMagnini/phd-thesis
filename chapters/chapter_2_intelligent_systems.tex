...
%
The experience $E$ can be represented as a given dataset, i.e., a collection of input data (and possibly their corresponding labels), but this is not the only way (e.g., \Cref{subsubsec:rl}).
%
