...
\begin{itemize}
    ...
    %
    \item[\textbf{RQ3}:]\label{itm:rq3} \emph{When and where should \ac{SKI} and \ac{SKE} be used?}
    ...
    %
    \item[\textbf{RQ4}:]\label{itm:rq4} \emph{How to design and develop \ac{NeSy} \ac{AI} systems that leverage \ac{SKI} and \ac{SKE}?}
