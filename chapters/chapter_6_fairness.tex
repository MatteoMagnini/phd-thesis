...
\begin{minipage}{0.5\textwidth}
    ...
    -- \textbf{\Cref{itm:rq0,itm:rq2,itm:rq3,itm:rq4}}
\end{minipage}
\end{flushright}
...
%
\Cref{fig:dp-sex,fig:dp-ethnicity,fig:dp-age} illustrates the trade-off between accuracy and \gls{DP} for \gls{FaUCI}, \gls{KDE}, \gls{GDP}, \gls{FNNC}, and \gls{NSIF} methods.
%
...
%
\Cref{fig:di-sex,fig:di-ethnicity,fig:di-age} shows the trade-off between accuracy and \gls{DI}.
%
...
%
\Cref{fig:eo-sex,fig:eo-ethnicity,fig:eo-age} presents the trade-off between accuracy and \gls{EO}.
%
