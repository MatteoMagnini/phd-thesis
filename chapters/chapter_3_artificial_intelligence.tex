...
\begin{figure}
    \centering
    \includegraphics[angle=90, height=0.9\textheight]{figures/ai-map2.eps}
    \caption[Overview of the field of artificial intelligence]{
        \Gls{AI} map illustrating the main subfields with a focus on symbolic and sub-symbolic approaches.
    }
    \label{fig:ai-map}
\end{figure}
