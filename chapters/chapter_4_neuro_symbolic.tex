...
\Cref{fig:pie-ski-logic} illustrates the distribution of these shapes across surveyed \gls{SKE} methods.
%
...
\paragraph[Decompositional SKE]{Decompositional \Gls{SKE}}\label{par:decompositional-ske}
