...
\begin{table}
    ...
    \begin{tabular}{c | c c c c c} \toprule
        \textbf{Method} & \makecell{\textbf{Document}\\\textbf{Free \ref{item:f1}}} & \makecell{\textbf{Training}\\\textbf{Free \ref{item:f2}}} & \makecell{\textbf{Construction}\\\textbf{\ref{item:f3}}} & \makecell{\textbf{Prompt}\\\textbf{Templating \ref{item:f4}}} & \makecell{\textbf{Consistency}\\\textbf{\ref{item:f5}}} \\
        \midrule
