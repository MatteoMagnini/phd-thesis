\begin{table}[ht]
    ...
    \caption[Results on the Animals ontology]{%
        ...
        All results have been analysed with the Chi-Squared test (p-value $<$ 0.05).
        The null hypothesis is that there is no correlation between the ontology constructed by ExactLearner+LLM and the Animals ontology.
        They all have p-value lower than 0.05 (i.e., refused null hypothesis).
    }
