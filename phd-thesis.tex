...
\begin{abstract}
    ...
    \sloppypar
    \textbf{Keywords} -- \emph{\acrlong{AI}, \acrlong{NeSy} \gls{AI}, \acrlong{SKI}, \acrlong{SKE}, \acrlongpl{LLM}, intelligent systems, autonomous learning.}
\end{abstract}
...
\begin{acknowledgements} % this is optional
    ...
    %
    At the very end of this journey I got married, and I want to thank all my friends who made this day unforgettable and help me in the organization.
    %
    The wedding and the thesis together took most of my energy, and by far 2025 has been the most intense year of my life.
    %
    ...
    %
    Alberto, Eugenio, Marco, Enrico, Michele, Federico, the researchers at the department of informatics of the Oslo university, the students and the people who frequent the pub nearby Cesena campus.
    ...
    %
    To be honest, it is a very rushed -- and out of time -- review, that me myself I would not have written even for a workshop paper.
    %
    Is this a case of \emph{Gollum effect}\footnote{\url{https://doi.org/10.1038/d41586-025-01588-w}}?
    ...
    %
    The free people of Ukraine are fighting every day to defend not only their homeland, but the entire Europe and also the values of freedom and democracy that we all cherish, and without which scientific research itself would not be possible as we know it.
