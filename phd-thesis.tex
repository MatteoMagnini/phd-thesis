...
\input{chapters/chapter_8_fairness}
\printbibliography[title=References,heading=bibintoc]
\end{refsection}
...
\begin{refsection}
\input{chapters/chapter_9_nesy_applications}
\input{chapters/chapter_10_autonomous_learning_systems}
\input{chapters/chapter_11_conclusions}
\printbibliography[title=References,heading=bibintoc]
\end{refsection}
